...
# CLAUDE_CODE_OAUTH_TOKEN. Bei Ablauf: als jens `claude setup-token`, neuen Wert
# in diese Datei schreiben. Ohne Datei faellt claude auf ~/.claude-Creds zurueck.
TOKEN_FILE="${MCP_RECALL_TOKEN_FILE:-/home/jens/.config/mcp-recall/consolidation.env}"
